...
{
   sealed class AwsMultiPartWriteStream : PolyfilledWriteStream
   {
      ...
      public AwsMultiPartWriteStream(AwsS3FileStorage parent, string key, string uploadId) : base(5 * 1024 * 1024)
      {
         _parent = parent;
         _key = key;
         _uploadId = uploadId;
